...
>
> **What I built:**
> - 🏋️ A complete workout builder with day-by-day split programming, warm-ups, cardio sessions, and exercise libraries
...
> - 🛡️ Role-based multi-tenancy (Admins + Coaches) with ASP.NET Core Identity, real-time account deactivation, and account lockout security
...
Built with ❤️ for fitness professionals who deserve better tools.
