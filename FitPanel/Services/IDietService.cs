...
public interface IDietService
{
    ...
    Task<(bool Success, string Message)> DeleteMealItemAsync(int mealId);                          // ← NEW
    Task<(bool Success, string Message)> UpdateMealItemAsync(int mealId, CreateMealItemDto dto);   // ← NEW
}